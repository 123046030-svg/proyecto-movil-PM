...
export default function CajaScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.boton} onPress={() => router.push('/caja/cuenta')}>
        <Text style={styles.textoBoton}>Consultar cuenta</Text>
      </Pressable>

      <Pressable style={styles.boton} onPress={() => router.push('/caja/registrar-pago')}>
        <Text style={styles.textoBoton}>Registrar pago</Text>
      </Pressable>

      <Pressable style={styles.boton} onPress={() => router.push('/caja/ventas')}>
        <Text style={styles.textoBoton}>Ver ventas</Text>
      </Pressable>
