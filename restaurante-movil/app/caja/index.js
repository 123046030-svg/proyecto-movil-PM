      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.encabezado}>
          ...
          <Text style={styles.descripcion}>
            Control de cuentas y ventas
          </Text>

          <View style={styles.usuarioCard}>
            <Text style={styles.usuarioLabel}>Caja administrada por
            </Text>
            <Text style={styles.usuarioNombre}>
              {usuario?.nombre || 'Personal de Caja'}
              </Text>
          </View>
        </View>
        ...
        <View style={styles.menu}>
          <Pressable
            ...
            onPress={() => router.push('/caja/cuenta')}
          >
            ...
            <View style={styles.informacionOpcion}>
              <Text style={styles.tituloOpcion}>Consultar cuenta</Text>
              <Text style={styles.descripcionOpcion}>
                Revisar el consumo de una mesa
              </Text>
            </View>
          ...
          <Pressable
            ...
            onPress={() => router.push('/caja/registrar-pago')}
          >
            <View style={styles.numeroOpcion}>
            ...
            <View style={styles.informacionOpcion}>
              <Text style={styles.tituloOpcion}>Registrar pago</Text>
              <Text style={styles.descripcionOpcion}>
          ...
          <Pressable
            ...
            onPress={() => router.push('/caja/ventas')}
          >
            <View style={styles.numeroOpcion}>
            ...
            <View style={styles.informacionOpcion}>
              <Text style={styles.tituloOpcion}>Ventas</Text>
              <Text style={styles.descripcionOpcion}>
        ...
        <Text style={styles.pie}>CoffeReg · Módulo Caja</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
