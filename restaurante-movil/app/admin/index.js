      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.encabezado}>
          <View style={styles.iconoContainer}>
            <Text style={styles.icono}>A</Text>
          </View>

          <Text style={styles.titulo}>Administración</Text>

          <Text style={styles.descripcion}>
            Control general de CoffeReg
          </Text>

          <View style={styles.usuarioCard}>
            <Text style={styles.usuarioLabel}>Administración de
            </Text>
            <Text style={styles.usuarioNombre}>
            {usuario?.nombre || 'Regina'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.menu}>
          ...
          >
            ...
            <View style={styles.informacionOpcion}>
              <Text style={styles.tituloOpcion}>Usuarios</Text>
          ...
          >
            ...
            <View style={styles.informacionOpcion}>
              <Text style={styles.tituloOpcion}>Roles</Text>
              <Text style={styles.descripcionOpcion}>
                Revisar los roles del sistema
              </Text>
            </View>
          ...
          >
            ...
            <View style={styles.informacionOpcion}>
              <Text style={styles.tituloOpcion}>Estadísticas</Text>
              <Text style={styles.descripcionOpcion}>
                Consultar pedidos, ventas e ingresos
              </Text>
            </View>
...
>
  ...
  <View style={styles.informacionOpcion}>
    ...
    <Text style={styles.descripcionOpcion}>
      Generar reportes de ventas, pedidos y productos
    </Text>
  </View>
  ...
  <Text style={styles.flecha}>›</Text>
        ...
        <Text style={styles.pie}>CoffeReg · Módulo Administrador</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
