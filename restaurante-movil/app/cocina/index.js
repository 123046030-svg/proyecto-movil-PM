      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.encabezado}>
          ...
          <View style={styles.usuarioCard}>
            <Text style={styles.usuarioLabel}> Cocinero
            </Text>
            <Text style={styles.usuarioNombre}>
              {usuario?.nombre || 'Personal de Cocina'}
              </Text>
          </View>
        </View>
        ...
        <View style={styles.menu}>
          <Pressable
            ...
            onPress={() => router.push('/cocina/pedidos')}
          >
        ...
        <View style={styles.mensajeCard}>
          <Text style={styles.mensajeTitulo}>Flujo de cocina</Text>

          <Text style={styles.mensajeTexto}>
            Recibe pedidos, cambia su estado a preparación y márcalos
            como listos cuando estén terminados.
          </Text>
        </View>
        ...
        <Text style={styles.pie}>CoffeReg · Módulo Cocina</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
